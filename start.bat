...
:run
qemu-system-x86_64 -m 218 -bios OVMF_CODE.fd -boot menu=on -drive format=raw,file=fat:rw:os/ -rtc clock=host,base=utc -cpu qemu64,+x2apic -d int,cpu_reset,guest_errors -D qemu.log
goto :eof